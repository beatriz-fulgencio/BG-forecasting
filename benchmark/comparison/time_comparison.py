...
Uses paired t-tests and independent t-tests for comparisons.
"""
...
class TimeStatisticalSignificanceTester:
    """
    Test statistical significance of metric differences between experiments.
    
    Uses t-tests for all comparisons:
    - Paired t-test (same patients across experiments)
    - Independent t-test (different patient sets)
    ...
    def paired_comparison(self, 
        ...
        """
        Perform paired t-test comparison between two datasets.
        
        Args:
            data1: First dataset
            data2: Second dataset
            test_type: Always uses 'parametric' (paired t-test)
    ...
    def independent_comparison(self,
                              ...
                              alternative: str = 'two-sided') -> Dict:
        """
        Perform independent t-test comparison between two datasets.
        
        Args:
            data1: First dataset
            data2: Second dataset
            test_type: Always uses 'parametric' (independent t-test)
            alternative: 'two-sided', 'less', or 'greater'
